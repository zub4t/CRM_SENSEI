...
function nnew() {
    ...
    fetch('/CRM_SENSEI/management/employee/employee_nar.jsp', {
        method: "GET",
        headers: {
            "Content-Type": "application/x-www-form-urlencoded; charset=utf-8",
        }
...
function goToEmployeeId(employeeId) {
    document.getElementById("modal_crm").style.display = "block";
    fetch('/CRM_SENSEI/EmployeeController?pwhat=edit&empId=' + employeeId, {
        method: "POST",
        headers: {
            "Content-Type": "application/x-www-form-urlencoded; charset=utf-8",
        }
...
function removeEmployee(employeeId) {
    fetch('/CRM_SENSEI/EmployeeController?pwhat=delete&id=' + employeeId, {
        method: "POST",
        headers: {
            "Content-Type": "application/x-www-form-urlencoded; charset=utf-8",
        }
