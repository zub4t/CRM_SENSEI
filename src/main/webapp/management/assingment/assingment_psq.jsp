...
<html>
    ...
    <body>
        ...
        <div id="table_container">
            ...
            <span class="plusButton" onclick="window.location.href = '/CRM_SENSEI/management/assingment/assingment_nar.jsp'"><img  src="/CRM_SENSEI/resources/plus-sign.png" width="20px"/></span>
                <%}%>
