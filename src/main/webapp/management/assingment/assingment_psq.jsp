...
<html>
    ...
    <body>
        ...
        <div id="table_container">
            <span class="plusButton" onclick="window.location.href = '/CRM_SENSEI_EXTERNAL/management/assingment/assingment_nar.jsp'"><img  src="/CRM_SENSEI_EXTERNAL/resources/plus-sign.png" width="20px"/></span>
