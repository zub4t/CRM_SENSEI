...
<html>
    <head>
        ...
        %>
        <script src="/CRM_SENSEI/report_owner/report_owner.js"></script>
        <link href="/CRM_SENSEI/report_owner/report_owner.css" rel="stylesheet"/>
    ...
    <body>
        ...
        <div class="main-content">  
            <div class="form" style="height: 500px">
                ...
                <form class="formnar" name="reportPsq" method="POST" action="/CRM_SENSEI/Rpt4">
