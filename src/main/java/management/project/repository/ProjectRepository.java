...
public class ProjectRepository {
    ...
    public void insertProject(String n_process, String nme, float expected_sale, float effective_sale, float effective_purchase) {
        int con = DBManager.getConnetion();
        PreparedStatement pstmt = null;

        try {
            pstmt = DBManager.getPreparedStatement(con, "insert into project (n_process,customer_nme,expected_sale,effective_sale,effective_purchase) values(?,?,?,?,?)");
